...
# import paho.mqtt.client as mq # Untuk mengaksees MQTT 
...
#              return "Koneksi ke MongoDB gak berhasil", 500
#         else:
#             return "oops data kamu kosong"

# if __name__ == '__main__':
#     web.run(debug=True)

from flask import Flask, request, jsonify # Memanggil flask untuk membuat local server, request untuk dan jsonify
import paho.mqtt.client as mq # Untuk mengakses MQTT 
from pymongo import MongoClient as mongo # Untuk mengakses database menggunakan mongo 
from pymongo.errors import ConnectionFailure 
